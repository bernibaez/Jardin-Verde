            ...
            {cart.map((item, index) => (
              ...
              >
                <div className="flex gap-6 p-6">
                  {/* Product Image */}
                  <div className="relative">
                    <div className="h-32 w-32 flex-shrink-0 overflow-hidden rounded-xl bg-gray-50 group-hover:scale-105 transition-transform duration-300">
                      <ImageWithFallback
                        src={item.image}
                        alt={item.name}
                  ...
                  <div className="flex-1 flex flex-col justify-between">
                    <div className="space-y-2">
                      <div className="flex justify-between items-start">
                        <div>
                          <Link
                            to={`/product/${item.id}`}
                            className="text-xl font-bold text-gray-900 hover:text-[#2D5128] transition-colors"
                          >
                            {item.name}
                          </Link>
                          <p className="text-sm text-gray-500 font-medium">{item.category}</p>
                          <div className="flex items-center gap-2 mt-1">
                            <span className="text-2xl font-black text-[#2D5128]">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-2xl font-black text-[#2D5128]">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
                ...
                <Link
                  to="/checkout"
                  className="mt-6 w-full bg-[#2D5128] hover:bg-[#1f3d1f] text-white py-4 rounded-xl font-bold transition-all transform hover:scale-105 shadow-lg flex items-center justify-center gap-2"
                >
                  Proceder al Pago
